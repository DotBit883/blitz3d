...
void DeclStmtNode::translate(Codegen *g) { decl->translate(g); }
...
void LabelNode::translate(Codegen *g) { g->label("_l" + ident); }
...
void GotoNode::translate(Codegen *g) { g->code(jump("_l" + ident)); }
...
void GosubNode::translate(Codegen *g) { g->code(jsr("_l" + ident)); }
