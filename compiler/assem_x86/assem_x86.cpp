...
typedef std::map<string, Inst *> InstMap;
...
void Assem_x86::assemInst(const std::string &name, const std::string &lhs,
  ...
  if (inst->flags & (_0 | _1 | _2 | _3 | _4 | _5 | _6 | _7 | _R)) {
    ...
    // find the memop;
    const Operand &mop = (inst->rmode & (MEM | MEM8 | MEM16 | MEM32 | R_M |
                                         R_M8 | R_M16 | R_M32))
                             ? rop
                             : lop;
